...
const MyAppointments = () => {
  ...
  return (
    ...
    <div>
      <div className=' text-black py-6 px-7 text-medium pb-8'>
        <p className='font-sm text-white bg-black'>This day is good</p>
      </div>
          ...
          {doctors.slice(0,3).map((item,index)=>(
            <div className='grid grid-cols-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-2 border-b' key={index}>
              ...
              <div className='flex-1 text-sm text-zinc-600'>
                ...
                <p className='text-sm mt-1'><span className='text-sm text-neutral-700 font-medium'>Date & Time:</span>18, October, 2025 / 5:02 PM</p>
              </div>
              <div></div>
