...
const Login = () => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className='min-h flex item-center'>
      <div className='flex flex-col gap-3 m-auto items-start p-8 min-w-[340px] sm:min-w-96 border rounded-xl  text-zinc-600 text-sm shawdow-lg'>
